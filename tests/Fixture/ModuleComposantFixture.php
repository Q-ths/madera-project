...
/**
 * ModuleComposantFixture
 *
 */
class ModuleComposantFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'projet_module_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'projet_module_id' => ['type' => 'index', 'columns' => ['projet_module_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'module_composant_ibfk_1' => ['type' => 'foreign', 'columns' => ['projet_module_id'], 'references' => ['projet_module', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'tva' => 1.5,
                'user_id' => 1,
                'derniere_date_modification' => '2019-01-05 08:47:56',
                'date_in' => '2019-01-05 08:47:56',
                'date_out' => '2019-01-05 08:47:56',
                'projet_module_id' => 1
            ],
        ];
        parent::init();
