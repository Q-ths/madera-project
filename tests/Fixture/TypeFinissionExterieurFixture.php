...
/**
 * TypeFinissionExterieurFixture
 *
 */
class TypeFinissionExterieurFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'type_finission_exterieur';
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'derniere_date_modification' => '2018-11-13 10:18:42',
                'date_in' => '2018-11-13 10:18:42',
                'date_out' => '2018-11-13 10:18:42'
            ],
        ];
        parent::init();
    }
