...
class ModuleProjetFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'module_projet_module_id_fk' => ['type' => 'index', 'columns' => ['module_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'module_projet_ibfk_1' => ['type' => 'foreign', 'columns' => ['projet_id'], 'references' => ['projet', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'module_projet_module_id_fk' => ['type' => 'foreign', 'columns' => ['module_id'], 'references' => ['module', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'marge' => 1,
                'user_id' => 1,
                'derniere_date_modification' => '2019-01-05 11:16:08',
                'date_in' => '2019-01-05 11:16:08',
                'date_out' => '2019-01-05 11:16:08',
                'projet_id' => 1,
                'module_id' => 1
            ],
        ];
