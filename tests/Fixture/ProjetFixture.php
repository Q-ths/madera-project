...
class ProjetFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reference' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'date_creation' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            ...
            'utilisateur_id' => ['type' => 'index', 'columns' => ['utilisateur_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'projet_ibfk_1' => ['type' => 'foreign', 'columns' => ['client_id'], 'references' => ['client', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'projet_ibfk_2' => ['type' => 'foreign', 'columns' => ['utilisateur_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date_creation' => '2019-01-07 23:16:33',
