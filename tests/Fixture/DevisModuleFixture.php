 ...
 *
 */
class DevisModuleFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'devis_module_ibfk_1' => ['type' => 'foreign', 'columns' => ['devis_id'], 'references' => ['devis', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
