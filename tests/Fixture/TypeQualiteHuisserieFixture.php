...
/**
 * TypeQualiteHuisserieFixture
 *
 */
class TypeQualiteHuisserieFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'type_qualite_huisserie';
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'derniere_date_modification' => '2018-12-06 15:16:45',
                'date_in' => '2018-12-06 15:16:45',
                'date_out' => '2018-12-06 15:16:45'
            ],
        ];
        parent::init();
    }
