<div ng-controller="GammeController">
    ...
    <div class="row title-page">
        ...
        <div class="col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1 align-text-right">
            <button class="btn btn-info" id="to-fournisseur-create" type="button"><i class="fa fa-plus"></i></button>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <table class="table table-striped">
                ...
                <tbody>
                <tr class="d-flex" ng-repeat="item in fournisseurs" >
                    ...
                    <td class="col-1">
                        <a href="/fournisseur/edit?id={{item.id}}" ><i class="material-icons">edit</i></a>
                    </td>
                </tr>
                </tbody>
            </table>
...
<script>
    ...
    angular.module('fournisseur',[])
        .controller('GammeController', ['$scope','$http', function ($scope,$http) {
            ...
            /* Event */
            $('#to-fournisseur-create').click(function () {
                window.location.href = "/fournisseur/create"
            });
            /**/
