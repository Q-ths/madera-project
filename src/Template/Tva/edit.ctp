<div ng-controller="TvasController">
    ...
    <div class="row title-page">
        ...
        <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 align-text-right">
            ...
            <a class="btn btn-page-actions" ng-click="edit()" ><i class="material-icons icons-page-actions">save</i></a>
        </div>
    </div>
...
<script>
    angular.module('tva', [])
        .controller('TvasController', ['$scope','$http', function ($scope,$http) {
            ...
            $http.get('/tva/view/' + window.location.search.split('id=')[1]).then(function ($response) {
                $scope.tva = $response.data;
            });
            ...
            $scope.edit = function () {
                ...
                fetch('/tva/edit/' + $scope.tva.id, {headers:header, method:'post', body:JSON.stringify($scope.tva)})
